...
async function getNumberOfUserSkills(req: Request, res: Response) {
    try {
        ...
        const swapCompletedCount = await Offer.count({
            where: {
                [Op.or]: [
                    { req_user_id: userId, status_id: 'f3813160-560e-44fa-94a7-3b1fdf730ad2' },
                    { res_user_id: userId, status_id: 'f3813160-560e-44fa-94a7-3b1fdf730ad2' } // 'Completed' status ID
                ]
            }
        });
